    ...
    <div class="card-body">
        <form action="{{ route("teller.membership.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('residental_num') ? 'has-error' : '' }}">
                ...
                <input type="text" id="residental_num" name="residental_num" class="form-control" value="{{ old('residental_num', isset($member) ? $member->residental_num : '') }}" required>
            ...
            <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                ...
                <textarea id="address" name="address" class="form-control" rows="2" required>{{ old('name', isset($member) ? $member->address : '') }}</textarea>
            ...
            <div class="form-group {{ $errors->has('birth_date') ? 'has-error' : '' }}">
                ...
                <input type="date" id="birth_date" name="birth_date" class="form-control" value="{{ old('name', isset($member) ? $member->birth_date : '') }}" required>
            ...
            <div class="form-group {{ $errors->has('phone_num') ? 'has-error' : '' }}">
                ...
                <input type="text" id="phone_num" name="phone_num" class="form-control" value="{{ old('phone_num', isset($member) ? $member->phone_num : '') }}" required>
